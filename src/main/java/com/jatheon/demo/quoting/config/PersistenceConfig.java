package com.jatheon.demo.quoting.config;
...
@EnableJpaRepositories(basePackages = "com.jatheon.demo.quoting.repository")
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan("com.jatheon.demo.quoting.model");
